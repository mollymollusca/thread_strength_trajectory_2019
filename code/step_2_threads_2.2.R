...
wd_plot_dir <- "~/thread_strength_trajectory_2019/analysis_20190416/Trajectories_plots"
setwd(wd_plot_dir)
wd_output_error_header <- "~/thread_strength_trajectory_2019/analysis_20190416/Error_header"
setwd(wd_output_error_header)
wd_output_error_plots <- "~/thread_strength_trajectory_2019/analysis_20190416/Error_plots"
setwd(wd_output_error_plots)
wd_peak_valley_output <- "~/thread_strength_trajectory_2019/analysis_20190416/PeakValley"
