...
file_summary <- "summary2019-05-06.csv"
...
#nested model
fun_Mesocosm <- lmer(transvec ~ species * Temp * Food + (1 | Mesocosm), data=tt_single_th, REML = FALSE)
summary(fun_Mesocosm)
Anova(fun_Mesocosm)
...
m1 <- lmer(transvec ~ species * Temp * Food + (1 | Mesocosm), data=tt_single_th, REML = FALSE)
m2 <- lmer(transvec ~ species * Temp * Food + (Food | Mesocosm) , data=tt_single_th, REML = FALSE)
# m3 is the best...
m3 <- lmer(transvec ~ species * Temp * Food + (Temp | Mesocosm), data=tt_single_th, REML = FALSE)
summary(m3)
m4 <- lmer(transvec ~ species * Temp * Food + (species | Mesocosm), data=tt_single_th, REML = FALSE)
m5 <- lmer(transvec ~ species * Temp * Food + (Food | Mesocosm) , data=tt_single_th, REML = FALSE)
m6 <- lmer(transvec ~ species * Temp * Food + (1+Food | Mesocosm), data=tt_single_th, REML = FALSE)
m7 <- lmer(transvec ~ species * Temp * Food + (1 | Mesocosm)+ (1|Mesocosm:Temp), data=tt_single_th, REML = FALSE)
...
fun_Mesocosm_max <- lmer(trans_max ~ species * Temp * Food + (1 | Mesocosm), data=tt_max, REML = FALSE)
...
str(tross)
fun_Mesocosm_max_tross <- lmer(trans_max ~ Temp * Food + (1| Mesocosm), data=tross_max, REML = FALSE)
...
fun_Mesocosm_thread_count_tross <- lmer(trans_thread_count ~ Temp * Food + (1 | Mesocosm), data=tross_max, REML = FALSE)
...
fun_Mesocosm <- lmer(transvec ~ Temp * Food + (1| Mesocosm), data=tross_single_th, REML = FALSE)
summary(fun_Mesocosm)
Anova(fun_Mesocosm)
setwd(newfolder)
...
fun_Mesocosm_max_gallo <- lmer(trans_max ~ Temp * Food + (1| Mesocosm), data=gallo_max, REML = FALSE)
...
fun_Mesocosm_thread_count_gallo <- lmer(trans_thread_count ~ Temp * Food + (1 | Mesocosm), data=gallo_max, REML = FALSE)
summary(fun_Mesocosm_thread_count_gallo)
Anova(fun_Mesocosm_thread_count_gallo)
setwd(newfolder)
...
fun_Mesocosm <- lmer(transvec ~ Temp * Food + (1 | Mesocosm), data=gallo_single_th, REML = FALSE)
summary(fun_Mesocosm)
Anova(fun_Mesocosm)
setwd(newfolder)
...
m0 <- glm(transvec ~ species * Temp * Food, data=tt_single_th)
m1 <- lme(transvec ~ species * Temp * Food, random=~1|Mesocosm, data=tt_single_th, method = "ML")
m2 <- lme(transvec ~ species * Temp * Food, random=~Food|Mesocosm, data=tt_single_th, method = "ML")
